...
git add README.md docs .gitignore databricks_dab_ml/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-1150699392227017.17.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-4093306949534053.13.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[databricks-dab-ml/databricks.yml](../databricks_dab_ml/databricks.yml) file.
...
Follow the instructions in [databricks-dab-ml/resources/README.md](../databricks_dab_ml/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../databricks_dab_ml/resources/README.md)  to propose, test, and deploy
