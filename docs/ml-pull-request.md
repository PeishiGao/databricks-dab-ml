...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks-dab-ml-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-1150699392227017.17.azuredatabricks.net/explore/data/models/staging/databricks-dab-ml/databricks-dab-ml-model)
* [Prod model in UC](https://adb-4093306949534053.13.azuredatabricks.net/explore/data/models/prod/databricks-dab-ml/databricks-dab-ml-model)
. 
